...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        // Mobile: bottom sheet
        "fixed bottom-0 left-0 right-0 z-50 w-full rounded-t-2xl border-t border-x border-border bg-background p-5 shadow-xl",
        ...
        "sm:max-w-lg sm:rounded-xl sm:border sm:p-6",
